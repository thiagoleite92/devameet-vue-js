  ...
  methods: {
    ...
    async createMeet() {
      try {
        ...
        console.log(e);
        console.log('Erro ao cadastrar reunião:', e.message);
      }
    }
  },
  computed: {
  ...
  <div class="container-principal">
    ...
    <div class="container-grid-add">
      ...
      <div class="actions">
        <div>
          <img
            src="../../assets/images/thrash_white.svg"
            alt="Deletar objeto"
          />
        </div>
        <div>
          <img
            src="../../assets/images/rotate_right.svg"
            alt="Girar a Direita"
          />
        </div>
        <div>
          <img
            src="../../assets/images/rotate_left.svg"
            alt="Girar a Esquerda"
          />
        </div>
      </div>
    </div>
...
<style lang="scss" src="../../assets/styles/principal.scss"></style>
